    ...
    if ($resultado->num_rows > 0) {
        while ($fila = $resultado->fetch_assoc()) {
            ...
            */
            ...
            <td> <input type='text' id='nombre_".$fila['id']."'      name='nombre'   value='" . $fila['nombre'] . "'></td>
            <td> <input type='text' id='apellido_".$fila['id']."'    name='apellido' value='" . $fila['apellido'] . "'></td>
            <td> <input type='number' maxlength='9' onKeypress='if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;'  id='edad_".$fila['id']."'        name='edad'   value='" . $fila['edad'] . "'> </td>
            <td> <select name='genero' id='genero_".$fila['id']."'><option ".$selecH." value='Hombre'>Hombre</option><option ".$selecM." value='Mujer'>Mujer</option><option ".$selecN." value='No Especificar'>No Especificar</option></select></td>
            <td> <button onclick='actualizar(".$fila['id'].")'>Actualizar</button></td>
            </tr>";
